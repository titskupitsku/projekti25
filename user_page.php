                ...
                <form class="add-event-form" method="POST">
                    <div class="add-event-body">
                        <div class="add-event-input">
                            <input type="text" name="eventName" placeholder="Event Name" class="event-name" required  />
                        </div>
                        <div class="add-event-input">
                            <input type="text"  placeholder="Event Time From" name="eventTimeFrom" class="event-time-from" required />
                        </div>
                        <div class="add-event-input">
                            <input type="text"  placeholder="Event Time To" name="eventTimeTo" class="event-time-to" required />
                        </div>
                        <div class="add-event-input">
